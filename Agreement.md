...
- при **именовании веток**, ориентируемся на заголовок задачи, на ее номер, например: для задачи `Реализовать стартовое состояние игры #14` ветка будет такой `14-game-start-state`
...
- **стили**: можно использовать css in js, post css, css переменные, sass, scss.
